...
VALUES
    (1, 'artist1@test.com', 'AI아티스트', 'SELLER', 100, false, null, 'local', 'artist-001', true, false, NOW(), NOW(), 0),
    (2, 'creator2@test.com', '크리에이터Kim', 'SELLER', 50, false, null, 'local', 'creator-002', true, true, NOW(), NOW(), 0),
    (3, 'designer3@test.com', '디자이너Park', 'SELLER', 80, false, null, 'local', 'designer-003', true, false, NOW(), NOW(), 0),
    (4, 'prompter4@test.com', 'PromptMaster', 'SELLER', 120, false, null, 'local', 'prompter-004', true, true, NOW(), NOW(), 0),
    (5, 'user5@test.com', '그림쟁이', 'SELLER', 30, false, null, 'local', 'user-005', true, false, NOW(), NOW(), 0),
    (6, 'maker6@test.com', 'ImageMaker', 'SELLER', 70, false, null, 'local', 'maker-006', true, false, NOW(), NOW(), 0),
    (7, 'artist7@test.com', '예술가Lee', 'SELLER', 90, false, null, 'local', 'artist-007', true, true, NOW(), NOW(), 0),
    (8, 'pro8@test.com', 'ProDesigner', 'SELLER', 150, false, null, 'local', 'pro-008', true, false, NOW(), NOW(), 0),
    (9, 'creative9@test.com', '창작자Choi', 'SELLER', 60, false, null, 'local', 'creative-009', true, false, NOW(), NOW(), 0),
    (10, 'pixel10@test.com', 'PixelArtist', 'SELLER', 40, false, null, 'local', 'pixel-010', true, true, NOW(), NOW(), 0),
