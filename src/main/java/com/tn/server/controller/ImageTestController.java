...
public class ImageTestController {
    ...
    public ResponseEntity<ApiResponse<String>> uploadImage(
        ...
        return ResponseEntity.ok(ApiResponse.success("업로드에 성공했습니다.",
    ...
    public ResponseEntity<ApiResponse<String>> deleteImage(
        ...
        return ResponseEntity.ok(ApiResponse.success("삭제 요청 완료","삭제 요청 완료 (R2 확인 필요)"));
    }
    ...
    public ResponseEntity<ApiResponse<String>> getPresignedGetUrl(
        ...
        return ResponseEntity.ok(ApiResponse.success("URL 발급에 성공했습니다.", downloadUrl));
    }
    ...
    public ResponseEntity<ApiResponse<String>> uploadFromUrl(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                "URL 발급에 성공했습니다.",(isSecret ? "[비공개-키 반환] " : "[공개-URL 반환] ") + result
        ));
    }
}
